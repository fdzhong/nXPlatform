      ...
      v => v != null).then(initialed => {
        if (!initialed) {console.log('Hello Local');
          ...
          this.storage.set('b1f1-D1', {
            ...
            status: '待接待',
            issues: [
              { issueid: '192901920381-2903', status: '待分派' },
